    ...
    ExportService.prototype.pdfGroupOverview = function (wcif) {
        ...
        wcif.events.forEach(function (event) {
            ...
            var _loop_1 = function (i) {
                ...
                groupSummary = event.id + ' - group ' + i + ' has ' + competitors.length + ' competitors, ' + judges.length + ' judges, '
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _common_classes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/classes */ "./src/common/classes.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GroupService = /** @class */ (function () {
    function GroupService() {
        ...
        this.configuration = new _common_classes__WEBPACK_IMPORTED_MODULE_1__["GeneralConfiguration"]();
    }
    GroupService.prototype.generateGrouping = function (eventId) {
        var _this = this;
        var handler = function (eventId, staff) { return _this.staffIsReadyForGrouping(eventId, staff); };
...
var environment = {
    ...
    wcaAppId: 'f5ec2a8308dcf8e7ec2db0a1244258e4753842dc330e5e188859b351ca277c5a',
    wcaSecret: 'd7d4ecc6d004bfa3108570021943a0b2276b204eb8bbe9901f1f1d61736c0ed2'
};
...
module.exports = __webpack_require__(/*! C:\Users\mvereecken\Desktop\AGE\src\main.ts */"./src/main.ts");
